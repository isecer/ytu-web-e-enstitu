...
namespace LisansUstuBasvuruSistemi.Utilities.MenuAndRoles
{
    public class SystemMenu : IMenu
    {
        ...
        [MenuAttribute(MenuID = 65000, MenuAdi = "Salon Rezervasyonu", MenuCssClass = "fa fa-file-text-o", MenuUrl = "", YetkisizErisim = false, YetkiliEnstituler = "010,020", SiraNo = 3)]
        public const string SalonRezervasyonIslemleri = "Salon Rezervasyon İşlemleri";

        [MenuAttribute(MenuID = 75000, MenuAdi = "Belge Talep", MenuCssClass = "fa fa-file-text-o", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010", SiraNo = 5)]
        public const string BelgeTalepIslemleri = "Belge Talep";

        [MenuAttribute(MenuID = 77000, MenuAdi = "Talep İşlemleri", MenuCssClass = "fa fa-file-text-o", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 6)]
        public const string TalepIslemleri = "Talep İşlemleri";

        [MenuAttribute(MenuID = 80000, MenuAdi = "Lisansüstü Başvuru", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 7)]
        public const string BasvuruIslemleri = "Başvuru İşlemleri";

        [MenuAttribute(MenuID = 80500, MenuAdi = "YTU Yeni Mezun Başvuru", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 8)]
        public const string YydBasvuruIslemleri = "YYD Başvuru İşlemleri";

        [MenuAttribute(MenuID = 81000, MenuAdi = "Yatay Geçiş Başvuru", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 9)]
        public const string YgBasvuruIslemleri = "YG Başvuru İşlemleri";

        [MenuAttribute(MenuID = 81500, MenuAdi = "Yeterlik İşlemleri", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 11)]
        public const string YeterlikIslemleri = "Yeterlik İşlemleri";

        [MenuAttribute(MenuID = 82300, MenuAdi = "Tez Danışmanı Öneri", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 14)]
        public const string TdoIslemleri = "Tez danışmanı öneri İşlemleri";

        [MenuAttribute(MenuID = 83300, MenuAdi = "Tez İzleme İşlemleri", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 15)]
        public const string TiIslemleri = "Tez İzleme İşlemleri";

        [MenuAttribute(MenuID = 83500, MenuAdi = "Mezuniyet İşlemleri", MenuCssClass = "fa fa-graduation-cap", MenuUrl = "", YetkisizErisim = true, YetkiliEnstituler = "010,020", SiraNo = 16)]
        public const string MezuniyetIslemleri = "Mezuniyet İşlemleri";

        [MenuAttribute(MenuID = 84000, MenuAdi = "Rapor İşlemleri", MenuCssClass = "fa fa-bar-chart-o", MenuUrl = "", YetkiliEnstituler = "010,020", SiraNo = 18)]
        public const string RaporIslemleri = "RaporIslemleri";

        [MenuAttribute(MenuID = 85000, MenuAdi = "Kullanıcı İşlemleri", MenuCssClass = "fa fa-group", MenuUrl = "", YetkiliEnstituler = "010,020", SiraNo = 21)]
        public const string KullaniciIslemleri = "Kullanıcı İşlemleri";

        [MenuAttribute(MenuID = 90000, MenuAdi = "Tanımlamalar", MenuCssClass = "fa fa-gears", MenuUrl = "", YetkiliEnstituler = "010,020", SiraNo = 24)]
        public const string Tanimlamalar = "Tanımlamalar";

        [MenuAttribute(MenuID = 100000, MenuAdi = "Sistem", MenuCssClass = "fa fa-desktop", MenuUrl = "", YetkiliEnstituler = "010,020", SiraNo = 27)]
    ...
    public class RoleNames : IRoleName, IMenu
    {
        ...
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Rezervasyon Yap", MenuCssClass = "fa fa-file-text-o", MenuUrl = "SR/Index", YetkisizErisim = false, SiraNo = 1)]
        [RoleAttribute(GorunurAdi = "Rezervasyon Yap", Kategori = "Salon Rezervasyonu", Aciklama = "")]
        public const string SrYap = "Rezervasyon Yap";
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Gelen Rezervasyonlar", MenuCssClass = "fa fa-file-text-o", MenuUrl = "SRGelenTalepler/Index", SiraNo = 2)]
        ...
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Özel Tanımlar", MenuCssClass = "fa fa-list-alt", MenuUrl = "SROzelTanimlar/Index", SiraNo = 3)]
        ...
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Salon Bilgi", MenuCssClass = "fa fa-list-alt", MenuUrl = "SRSalonBilgi/Index", SiraNo = 4)]
        [RoleAttribute(GorunurAdi = "Salon Bilgi", Kategori = "Salon Rezervasyonu", Aciklama = "")]
        public const string SrSalonBilgi = "Salon Bilgi";


        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Salon Tanımları", MenuCssClass = "fa fa-list-alt", MenuUrl = "SRSalonlar/Index", SiraNo = 5)]
        ...
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Talep Tipleri", MenuCssClass = "fa fa-list-alt", MenuUrl = "SRTalepTipleri/Index", SiraNo = 6)]
        ...
        [MenuAttribute(BagliMenuID = 65000, MenuAdi = "Salon Rezervasyon Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "SRAyarlar/Index", SiraNo = 7)]
        ...
        [MenuAttribute(BagliMenuID = 75000, MenuAdi = "Belge Talebi Yap", MenuCssClass = "fa fa-file-text-o", MenuUrl = "BelgeTalebi/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        ...
        [MenuAttribute(BagliMenuID = 75000, MenuAdi = "Gelen Belge Talepleri", MenuCssClass = "fa fa-file-text-o", MenuUrl = "GelenBelgeTalepleri/Index", SiraNo = 2)]
        ...
        [MenuAttribute(BagliMenuID = 75000, MenuAdi = "Belge Tip Detay", MenuCssClass = "fa fa-gear", MenuUrl = "BelgeTipDetay/Index", SiraNo = 3)]
        ...
        [MenuAttribute(BagliMenuID = 75000, MenuAdi = "Belge Tipleri", MenuCssClass = "fa fa-list-alt", MenuUrl = "BelgeTipleri/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 75000, MenuAdi = "Belge Talep Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "BelgeTalepAyar/Index", SiraNo = 5)]
        ...
        [MenuAttribute(BagliMenuID = 77000, MenuAdi = "Talep Yap", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TalepYap/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        public const string TalepYap = "Talep Yap";
        [MenuAttribute(BagliMenuID = 77000, MenuAdi = "Gelen Talepler", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TalepGelenTalepler/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 77000, MenuAdi = "Talep Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "TalepSureci/Index", SiraNo = 7)]
        [RoleAttribute(GorunurAdi = "Talep Süreci", Kategori = "Talep İşlemleri", Aciklama = "")]
        public const string TalepSureci = "Talep Süreci";

        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "Basvuru/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 0)]
        //[RoleAttribute(GorunurAdi = "Başvuru", Kategori = "Başvuru İşlemleri", Aciklama = "")]
        public const string Basvuru = "Basvuru";
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Dekont Giriş", MenuCssClass = "fa fa-file-text-o", MenuUrl = "DekontBilgi/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        //[RoleAttribute(GorunurAdi = "Başvuru", Kategori = "Başvuru İşlemleri", Aciklama = "")]
        public const string DekontGiris = "Dekont Giriş";
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Online Ödeme İşlemi", MenuCssClass = "fa fa-credit-card", MenuUrl = "OnlineOdeme/Index", YetkisizErisim = true, YetkiliEnstituler = "010,020", AuthenticationControl = "authenticatedControl(this)", SiraNo = 2)]
        //[RoleAttribute(GorunurAdi = "Başvuru", Kategori = "Başvuru İşlemleri", Aciklama = "")]
        public const string OnlineOdeme = "OnlineOdeme";
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "GelenBasvurular/Index", SiraNo = 3)]
        ...
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Başvuru Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "BasvuruSureci/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Kotalar", MenuCssClass = "fa fa-gear", MenuUrl = "Kotalar/Index", SiraNo = 5)]
        [RoleAttribute(GorunurAdi = "Kotalar", Kategori = "Lisansüstü Başvuru", Aciklama = "")]
        public const string Kotalar = "Kotalar";
        [MenuAttribute(BagliMenuID = 80000, MenuAdi = "Mülakat Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "MulakatSureci/Index", SiraNo = 6)]
        ...
        [MenuAttribute(BagliMenuID = 80500, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "YYDBasvuru/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 0)]
        public const string YydBasvuru = "YYDBasvuru";
        [MenuAttribute(BagliMenuID = 80500, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "YYDGelenBasvurular/Index", SiraNo = 3)]
        ...
        [MenuAttribute(BagliMenuID = 80500, MenuAdi = "Başvuru Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "YYDBasvuruSureci/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 80500, MenuAdi = "Kotalar", MenuCssClass = "fa fa-gear", MenuUrl = "YYDKotalar/Index", SiraNo = 5)]
        [RoleAttribute(GorunurAdi = "Kotalar", Kategori = "YTU Yeni Mezun Başvuru", Aciklama = "")]
        public const string YydKotalar = "YYD Kotalar";

        [MenuAttribute(BagliMenuID = 81000, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "YGBasvuru/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 0)]
        public const string YgBasvuru = "YGBasvuru";
        [MenuAttribute(BagliMenuID = 81000, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "YGGelenBasvurular/Index", SiraNo = 3)]
        ...
        [MenuAttribute(BagliMenuID = 81000, MenuAdi = "Başvuru Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "YGBasvuruSureci/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 81000, MenuAdi = "Kotalar", MenuCssClass = "fa fa-gear", MenuUrl = "YGKotalar/Index", SiraNo = 5)]
        [RoleAttribute(GorunurAdi = "Kotalar", Kategori = "Yatay Geçiş Başvuru", Aciklama = "")]
        public const string YgKotalar = "YG Kotalar";
        [MenuAttribute(BagliMenuID = 81000, MenuAdi = "Mülakat Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "YGMulakatSureci/Index", SiraNo = 6)]
        ...
        [MenuAttribute(BagliMenuID = 81500, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "Yeterlik/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        public const string YeterlikBasvuru = "Yeterlik Basvuru";
        [MenuAttribute(BagliMenuID = 81500, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "YeterlikGelenBasvurular/Index", SiraNo = 4)]
        [RoleAttribute(GorunurAdi = "Gelen Başvurular", Kategori = "Yeterlik İşlemleri", Aciklama = "")]
        ...
        [MenuAttribute(BagliMenuID = 81500, MenuAdi = "Yeterlik Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "YeterlikSureci/Index", SiraNo = 7)]
        [RoleAttribute(GorunurAdi = "Yeterlik Süreci", Kategori = "Yeterlik İşlemleri", Aciklama = "")]
        public const string YeterlikSureci = "Yeterlik Süreci";
        [RoleAttribute(GorunurAdi = "Yeterlik Süreci Kayıt", Kategori = "Yeterlik İşlemleri", Aciklama = "")]
        public const string YeterlikSureciKayıt = "Yeterlik Süreci Kayıt";
        [RoleAttribute(GorunurAdi = "Yeterlik Süreci Sil", Kategori = "Yeterlik İşlemleri", Aciklama = "")]
        public const string YeterlikSureciSil = "Yeterlik Süreci Sil";


        [MenuAttribute(BagliMenuID = 82300, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TDOBasvuru/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        public const string TdoBasvuru = "TDO Başvuru";
        [MenuAttribute(BagliMenuID = 82300, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TDOGelenBasvurular/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 82300, MenuAdi = "TDO Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "TDOAyarlar/Index", SiraNo = 7)]
        [RoleAttribute(GorunurAdi = "TDO Ayarları", Kategori = "Tez Danışmanı Öneri", Aciklama = "")]
        public const string TdoAyarlari = "TDO Ayarları";


        [MenuAttribute(BagliMenuID = 83300, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TIBasvuru/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        public const string TiBasvuru = "TI Başvuru";
        [MenuAttribute(BagliMenuID = 83300, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "TIGelenBasvurular/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 83300, MenuAdi = "TIK Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "TIAyarlar/Index", SiraNo = 7)]
        [RoleAttribute(GorunurAdi = "TIK Ayarları", Kategori = "Tez İzleme İşlemleri", Aciklama = "")]
        public const string TiAyarlari = "TI Ayarları";

        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Başvuru", MenuCssClass = "fa fa-file-text-o", MenuUrl = "Mezuniyet/Index", YetkisizErisim = true, AuthenticationControl = "authenticatedControl(this)", SiraNo = 1)]
        public const string MezuniyetBasvuru = "Mezuniyet Basvuru";
        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Gelen Başvurular", MenuCssClass = "fa fa-file-text-o", MenuUrl = "MezuniyetGelenBasvurular/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Mezuniyet Süreci", MenuCssClass = "fa fa-clock-o", MenuUrl = "MezuniyetSureci/Index", SiraNo = 7)]
        ...
        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Yönetmelikler", MenuCssClass = "fa fa-file-text-o", MenuUrl = "MezuniyetYonetmelikler/Index", SiraNo = 8)]
        ...
        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Yayın Türleri", MenuCssClass = "fa fa-gear", MenuUrl = "MezuniyetYayinTurleri/Index", SiraNo = 10)]
        ...
        [MenuAttribute(BagliMenuID = 83500, MenuAdi = "Mezuniyet Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "MezuniyetAyarlar/Index", SiraNo = 15)]
        ...
        [MenuAttribute(BagliMenuID = 84000, MenuAdi = "Lisansüstü Başvuru", MenuCssClass = "fa fa-bar-chart-o", MenuUrl = "RaporlarLUB/Index", SiraNo = 5)]
        ...
        [MenuAttribute(BagliMenuID = 84000, MenuAdi = "Belge Talepleri", MenuCssClass = "fa fa-bar-chart-o", MenuUrl = "RaporlarBT/Index", SiraNo = 10)]
        ...
        [MenuAttribute(BagliMenuID = 84000, MenuAdi = "Anketler", MenuCssClass = "fa fa-bar-chart-o", MenuUrl = "RaporlarAnket/Index", SiraNo = 15)]
        [RoleAttribute(GorunurAdi = "Anketler", Kategori = "Rapor İşlemleri", Aciklama = "")]
        public const string AnketlerRapor = "Anketler";


        [MenuAttribute(BagliMenuID = 85000, MenuAdi = "Kullanıcılar", MenuCssClass = "fa fa-list-alt", MenuUrl = "Kullanicilar/Index", SiraNo = 1)]
        ...
        [MenuAttribute(BagliMenuID = 85000, MenuAdi = "Yetki Grupları", MenuCssClass = "fa fa-list-alt", MenuUrl = "YetkiGruplari/Index", SiraNo = 1)]
        ...
        [MenuAttribute(BagliMenuID = 85000, MenuAdi = "Birimler", MenuCssClass = "fa fa-list-alt", MenuUrl = "Birimler/Index", SiraNo = 2)]
        [RoleAttribute(GorunurAdi = "Birimler", Kategori = "Kullanıcı İşlemleri", Aciklama = "")]
        public const string Birimler = "Birimler";
        [MenuAttribute(BagliMenuID = 85000, MenuAdi = "Ünvanlar", MenuCssClass = "fa fa-list-alt", MenuUrl = "Unvanlar/Index", SiraNo = 3)]
        [RoleAttribute(GorunurAdi = "Ünvanlar", Kategori = "Kullanıcı İşlemleri", Aciklama = "")]
        public const string Unvanlar = "Ünvanlar";

        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Uyruklar", MenuCssClass = "fa fa-list-alt", MenuUrl = "Uyruklar/Index", SiraNo = 1)]
        [RoleAttribute(GorunurAdi = "Uyruklar", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string Uyruklar = "Uyruklar";
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Şehirler", MenuCssClass = "fa fa-list-alt", MenuUrl = "Sehirler/Index", SiraNo = 4)]
        [RoleAttribute(GorunurAdi = "Şehirler", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string Sehirler = "Şehirler";
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Üniversiteler", MenuCssClass = "fa fa-list-alt", MenuUrl = "Universiteler/Index", SiraNo = 7)]
        [RoleAttribute(GorunurAdi = "Üniversiteler", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string Universiteler = "Üniversiteler";
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Enstitüler", MenuCssClass = "fa fa-list-alt", MenuUrl = "Enstituler/Index", SiraNo = 10)]
        [RoleAttribute(GorunurAdi = "Enstitüler", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string Enstituler = "Enstitüler";

        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Öğrenci Bölümleri", MenuCssClass = "fa fa-list-alt", MenuUrl = "OgrenciBolumleri/Index", SiraNo = 13)]
        ...
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Öğrenim Tipleri", MenuCssClass = "fa fa-list-alt", MenuUrl = "OgrenimTipleri/Index", SiraNo = 16)]
        ...
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Anabilim Dalları", MenuCssClass = "fa fa-list-alt", MenuUrl = "Anabilimdallari/Index", SiraNo = 19)]
        ...
        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Programlar", MenuCssClass = "fa fa-list-alt", MenuUrl = "Programlar/Index", SiraNo = 22)]
        [RoleAttribute(GorunurAdi = "Programlar", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string Programlar = "Programlar";

        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Bölüm-Program Eşleştir", MenuCssClass = "fa fa-gear", MenuUrl = "BolumEslestir/Index", SiraNo = 25)]
        [RoleAttribute(GorunurAdi = "Bölüm Eşleştir", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string BolumEslestir = "Bölüm Eşleştir";


        [MenuAttribute(BagliMenuID = 90000, MenuAdi = "Sınav Tipleri", MenuCssClass = "fa fa-gear", MenuUrl = "SinavTipleri/Index", SiraNo = 28)]
        [RoleAttribute(GorunurAdi = "Sınav Tipleri", Kategori = "Tanımlamalar", Aciklama = "")]
        public const string SinavTipleri = "Sınav Tipleri";


        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Duyurular", MenuCssClass = "fa fa-bullhorn", MenuUrl = "Duyurular/Index", SiraNo = 1)]
        [RoleAttribute(GorunurAdi = "Duyurular", Kategori = "Sistem", Aciklama = "")]
        public const string Duyurular = "Duyurular";

        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Gelen Mesajlar", MenuCssClass = "fa fa-envelope", MenuUrl = "Mesajlar/Index", SiraNo = 4)]
        ...
        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Mail İşlemleri", MenuCssClass = "fa fa-envelope", MenuUrl = "MailIslemleri/Index", SiraNo = 7)]
        ...
        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Mail Şablonları", MenuCssClass = "fa fa-pencil", MenuUrl = "MailSablonlari/Index", SiraNo = 10)]
        [RoleAttribute(GorunurAdi = "Mail Şablonları", Kategori = "Sistem", Aciklama = "")]
        public const string MailSablonlari = "Mail Şablonları";

        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Mail Şablonları (Sistem)", MenuCssClass = "fa fa-gear", MenuUrl = "MailSablonlariSistem/Index", SiraNo = 13)]
        ...
        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Mesaj Kategorileri", MenuCssClass = "fa fa-pencil", MenuUrl = "MesajKategorileri/Index", SiraNo = 16)]
        ...
        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Anketler", MenuCssClass = "fa fa-pencil", MenuUrl = "Anketler/Index", SiraNo = 19)]
        ...
        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Sistem Ayarları", MenuCssClass = "fa fa-cogs", MenuUrl = "SistemAyarlari/Index", SiraNo = 22)]
        [RoleAttribute(GorunurAdi = "Sistem Ayarları", Kategori = "Sistem", Aciklama = "")]
        public const string SistemAyarlari = "Sistem Ayarları";

        [MenuAttribute(BagliMenuID = 100000, MenuAdi = "Sistem Bilgilendirme", MenuCssClass = "fa fa-envelope", MenuUrl = "SistemBilgilendirme/Index", SiraNo = 25)]
