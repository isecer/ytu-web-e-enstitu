...
namespace LisansUstuBasvuruSistemi.MModels
{
    ...
    public class kmAnketlerCevap
    {
        ...
        {
            AnketCevapModel = new List<Models.AnketCevapModel>();
    ...
    public class frBasvuruSureci : BasvuruSurec
    {
        ...
        public List<ComboModelInt> CmbOgrenimTipBilgi { get; set; }
    }
    ...
    public class bsUrecDetay : BasvuruSurec
    {
        ...
        public bsUrecDetay()
        {
            CmbOgrenimTipBilgi = new List<ComboModelInt>();
            MulakatSonucu = new fmMulakatSonuc();
            MulakatBilgi = new fmMulakatNotGiris();
            AnketDetay = new List<Models.frAnketDetay>();
        }
    }
    ...
    public class KmMailGonder : GonderilenMailler
    {
        ...
        public List<ComboModelString> EMails { get; set; }
        ...
        public KmMailGonder()
        {
            ...
            EMails = new List<ComboModelString>();
    ...
    public class frSinavTipleri : SinavTipleri
    {
        ...
        {
            frSinavTipleriSPA = new List<Models.frSinavTipleriSPA>();
        }
    }
    ...
    public class krSinavTipleriOTNotAraliklari : SinavTipleriOTNotAraliklari
    {
        ...
        public List<string> ProgramKods { get; set; }
        public List<ComboModelString> IstenmeyenProgramlar { get; set; }
        public krSinavTipleriOTNotAraliklari()
        {
            PropName = new List<string>();
            ProgramKods = new List<string>();
            IstenmeyenProgramlar = new List<ComboModelString>();
        }
    }
    ...
    public class BasvuruDetayModelTDO : TDOBasvuru
    {
        ...
        public bool IsYeniBasvuruYapabilir { get; set; }
    ...
    public class kmBasvuruSurecOgrenimTipModel
    {
        ...
        public string EnstituKod { get; set; }
        public int BasvuruSurecID { get; set; }
        public List<ComboModelInt> EnstituOgrenimTipleri = new List<ComboModelInt>();
    ...
    {
        public List<ComboModelInt> GunNos { get; set; }
    }
    ...
    public class mailMulakatSinavYerJuriBilgi
    {
        ...
        public List<ComboModelInt> GonderilecekMails { get; set; }
    }
    ...
    public class rprModelProgramList
    {
        ...
        public List<ComboModelInt> EslestirilenBolumler { get; set; }
        public rprModelProgramList()
        {
            ...
            EslestirilenBolumler = new List<ComboModelInt>();
        }
    ...
    public class rprModelProgramAgnoKriterBilgi
    {
        ...
        public List<ComboModelString> OgretimKriterleri { get; set; }
        public rprModelProgramAgnoKriterBilgi()
        {
            OgretimKriterleri = new List<ComboModelString>();
        }
    }
    ...
    public class frMezuniyetYonetmelikler : MezuniyetYonetmelikleri
    {
        ...
        {
            MezuniyetYonetmelikData = new List<Models.krMezuniyetYonetmelikOT>();
        }
    }
    ...
    public class StudentControl
    {
        ...
        public List<StudentDersModel> AktifDonemDersKodlaris = new List<StudentDersModel>();
    ...
    public class StudentDersModel
    {
        ...
        public string DersKodNum { get; set; }
    }
    ...
    { 
        ...
        public List<ComboModelInt> WsSinavSonucList { get; set; }
        ...
        {
            WsSinavSonucList = new List<ComboModelInt>();
        }
    }
