...
{
    public partial class RprYeterlikKomiteAtamaBilgilendirmeFormuAbd : DevExpress.XtraReports.UI.XtraReport
    {
        public RprYeterlikKomiteAtamaBilgilendirmeFormuAbd(int yeterlikBasvuruId)
        {
            InitializeComponent();
            ...
            using (var entities = new LubsDbEntities())
            {
                ...
                var baslik = anabilimDaliAdi.ToUpper() + " ANABİLİM DALI BAŞKANLIĞINA";
                rtfText = rtfText.Replace("@Baslik", baslik);
                ...
                rtfText = rtfText.Replace("@EnstituMuduruTitle", isEnstituMururOrVekil ? "Enstitü Müdürü" : "Enstitü Müdür V.");
