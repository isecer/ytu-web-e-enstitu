            ...
            using (var db = new LisansustuBasvuruSistemiEntities())
            {
                var data = (from s in db.SRTalepleris
                            ...
                            select new
                            {
                                ...
                                JuriUyesi1 = s.SRTaleplerJuris.FirstOrDefault(p => p.JuriTipAdi == "YtuIciJuri1"),
                                JuriUyesi2 = s.SRTaleplerJuris.FirstOrDefault(p => p.JuriTipAdi == "YtuDisiJuri1"),
                            }).First();
                ...
                cellJuri1AbdUniversiteAdi.Text = data.JuriUyesi1.AnabilimdaliProgramAdi + "\r\n" + data.JuriUyesi1.UniversiteAdi;
                ...
                cellJuri2AbdUniversiteAdi.Text = data.JuriUyesi2.AnabilimdaliProgramAdi + "\r\n" + data.JuriUyesi2.UniversiteAdi;
