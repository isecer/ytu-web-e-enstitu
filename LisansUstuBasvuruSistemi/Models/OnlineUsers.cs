    ...
    public static class OnlineUsers
    {
        ...
        public static void AddUser(string UserId, string ip)
        {
            ...
            try
            {
                ...
                if (OnlineUsers._users.Where(p => p.UniqueId == UserId).Count() == 0)
                    OnlineUsers._users.Add(new OnlineUser { Tc = "Misafir", Name = "Misafir", LoginTime = DateTime.Now, UniqueId = UserId, Ip = clientIP });
        ...
        public static void RemoveUser(string UserId)
        {
            ...
            try
            {
                OnlineUsers._users.RemoveAll(p => p.UniqueId == UserId);
                OnlineUserCount = _users.Count;
            }
            catch { }
            finally
