...
elFinder.prototype.view = function(fm, el) {
	...
	this.plc  = $('<ul class="el-finder-places"><li><a href="javascript:void(0);" class="el-finder-places-root"><div/>'+this.fm.i18n(this.fm.options.places)+'</a><ul/></li></ul>').hide();
	...
	*/
	this.renderNav = function(tree) {
		var d = tree.dirs.length ? traverse(tree.dirs) : '',
			li = '<li><a href="javascript:void(0);" class="el-finder-tree-root" key="'+tree.hash+'"><div'+(d ? ' class="collapsed expanded"' : '')+'/>'+tree.name+'</a>'+d+'</li>';
		this.tree.html(li);
		...
		function traverse(tree) {
			...
			for (i=0; i < tree.length; i++) {
				...
				html += '<li><a href="javascript:void(0);" class="'+c+'" key="'+tree[i].hash+'"><div'+(tree[i].dirs.length ? ' class="collapsed"' : '')+'/>'+tree[i].name+'</a>';
...
elFinder.prototype.quickLook = function(fm, el) {
	...
	this.url  = $('<a href="javascript:void(0);"/>').hide().click(function(e) {
		e.preventDefault();
