...
namespace LisansUstuBasvuruSistemi.Controllers
{
    ...
    public class TDOBasvuruController : Controller
    {
        ...
        public ActionResult BasvuruYap(int? tdoBasvuruId, int? kullaniciId = null, string ekd = "")
        {
            ...
            var mmMessage = Management.getAktifTezDanismanOneriSurecKontrol(enstituKod, kullaniciId, tdoBasvuruId);
        ...
        public ActionResult BasvuruYap(KmTDOBasvuru kModel, string ekd)
        {
            ...
            var mmMessage = Management.getAktifTezDanismanOneriSurecKontrol(kModel.EnstituKod, kModel.KullaniciID, kModel.TDOBasvuruID.toNullIntZero());
            ...
            if (mmMessage.Messages.Count == 0)
            {
                ...
                if (kModel.TDOBasvuruID <= 0)
                {
                    ...
                    _db.SaveChanges();
                    Management.ObsDanismanBasvurBilgiEslestir(data.KullaniciID, data.TDOBasvuruID);
                }
                else
                {
        ...
        public ActionResult GetTdoDanismanFormu(int tdoBasvuruId, int? tdoBasvuruDanismanId, int tDODanismanTalepTipID)
        {
            ...
            {
                if (tdoBasvuruDanismanId.HasValue)
                {
                    ...
                    if (model.TDODanismanTalepTipID == TDODanismanTalepTip.TezDanismaniDegisikligi || model.TDODanismanTalepTipID == TDODanismanTalepTip.TezDanismaniVeBaslikDegisikligi)
                    {
                        model.VarolanTezDanismanID = tdoBd.TezDanismanID;
                        model.SinavTipID = null;
                        model.SinavAdi = null;
                        model.SinavPuani = null;
                        model.SinavYili = null;
                        model.TezDanismanID = 0;
                        model.TDAdSoyad = null;
                        model.TDUnvanAdi = null;
                        model.TDAnabilimDaliID = null;
                        model.TDAnabilimDaliAdi = null;
                        model.TDProgramKod = null;
                        model.TDProgramAdi = null;
                        model.TDSinavTipID = null;
                        model.TDSinavAdi = null;
                        model.TDSinavPuani = null;
                        model.TDSinavYili = null;
                        model.TDOgrenciSayisiDR = null;
                        model.TDOgrenciSayisiYL = null;
                        model.TDTezSayisiDR = null;
                        model.TDTezSayisiYL = null;
                ...
                model.SListTDoDanismanTalepTip = new SelectList(Management.CmbTDODanismanTalepTip(model.TDODanismanTalepTipID > TDODanismanTalepTip.TezDanismaniOnerisi, false), "Value", "Caption", model.TDODanismanTalepTipID);
        ...
        public ActionResult TdoDanismanFormuPost(TDOBasvuruDanisman kModel, bool? isTezDiliTr)
        {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                if (kModel.TDODanismanTalepTipID == TDODanismanTalepTip.TezBasligiDegisikligi || kModel.TDODanismanTalepTipID == TDODanismanTalepTip.TezDanismaniVeBaslikDegisikligi)
                {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                if (kModel.TDODanismanTalepTipID != TDODanismanTalepTip.TezDanismaniOnerisi)
                {
                    var oncekiBasvuru = tdoBas.TDOBasvuruDanismen.Where(p => p.TDOBasvuruDanismanID != kModel.TDOBasvuruDanismanID).OrderByDescending(o => o.BasvuruTarihi).First();
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                if (sendMail)
                {
                    Management.sendMailTDOBilgisi(kModel.TDOBasvuruDanismanID);
                }
            }
        ...
        public ActionResult TDODanismanOnayPost(TDOBasvuruDanisman kModel)
        {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                if (sendMail)
                {
                    ...
                    Management.sendMailTDODanismanOnay(kModel.TDOBasvuruDanismanID, kModel.DanismanOnayladi == true);
                }
            }
        ...
        public ActionResult TDOVarolanDanismanOnayPost(TDOBasvuruDanisman kModel)
        {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                {
                    LogIslemleri.LogEkle("TDOBasvuruDanisman", IslemTipi.Update, tdoBasvuruDanis.ToJson());
                    var Messages = Management.sendMailTDODanismanOnay(kModel.TDOBasvuruDanismanID, tdoBasvuruDanis.VarolanDanismanOnayladi.Value);
                }
            }
        ...
        public ActionResult TDOEYKDaOnayPost(int tdoBasvuruDanismanId, bool? eykDaOnaylandi, DateTime? eykDaOnaylandiOnayTarihi, string eykDaOnaylanmadiDurumAciklamasi)
        {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                {
                    LogIslemleri.LogEkle("TDOBasvuruDanisman", IslemTipi.Update, tdoBasvuruDanis.ToJson());
                    Management.sendMailTDOEYKOnay(tdoBasvuruDanismanId, eykDaOnaylandi.Value);
                }
            }
        ...
        public ActionResult TdoEykdaOnayPostEs(int tdoBasvuruEsDanismanId, bool? eykDaOnaylandi, DateTime? eykDaOnaylandiOnayTarihi, string eykDaOnaylanmadiDurumAciklamasi)
        {
            ...
            if (!mMessage.Messages.Any())
            {
                ...
                {
                    LogIslemleri.LogEkle("TDOBasvuruEsDanisman", IslemTipi.Update, tdoBasvuruEsDanis.ToJson());
                    Management.sendMailTDOEsEYKOnay(tdoBasvuruEsDanismanId, eykDaOnaylandi.Value);
                }
            }
        ...
        {
            var mmMessage = Management.getTDOBasvuruSilKontrol(id);
