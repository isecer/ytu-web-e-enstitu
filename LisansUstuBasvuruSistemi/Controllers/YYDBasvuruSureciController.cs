...
namespace LisansUstuBasvuruSistemi.Controllers
{
    ...
    public class YYDBasvuruSureciController : Controller
    {
        ...
        public ActionResult AlanDegistirmeIslemi(string UniqueID, bool IsAlanIciOrDisi)
        {
            ...
            else
            {
                ...
                if (mmMessage.Messages.Count == 0)
                {
                    ...
                    SistemBilgilendirmeBus.SistemBilgisiKaydet("Alan tipi değiştirme işlemi \r\n" + Msg, "MulakatSureci/AlanDegistirmeIslemi", LogType.Uyarı);
        ...
        public ActionResult Sil(int id)
        {
            ...
            if (kayit != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    SistemBilgilendirmeBus.SistemBilgisiKaydet(message, "YGBasvuruSureci/Sil<br/><br/>" + ex.ToExceptionStackTrace(), LogType.OnemsizHata);
        ...
        public ActionResult KazananKayit(int MulakatSonucID, int? KayitDurumID, bool YokODKontrolYap = true, bool? IsSave = null)
        {
            ...
            var ogrenciGSISBilgi = KullanicilarBus.StudentControl(ProgramBilgi.TcKimlikNo);
