    ...
    public class YYDBasvuruSureciController : Controller
    {
        ...
        public ActionResult getBsSubData(int id, int tbInx, bool IsDelete)
        {
            ...
            if (tbInx == 1)
            {
                ...
                #endregion
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsDetAnaBilgi", mdl);
            }
            if (tbInx == 2)
            {
                #region SinavTipleri
                ...
                #endregion
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsSinavTipleri", mdl);
            }
            if (tbInx == 3)
            {
                ...
                #endregion
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsKotalar", mdl);
            }
            if (tbInx == 4)
            {
                ...
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsMulakat", mdl);
            }
            if (tbInx == 5)
            {
                ...
                #endregion
                mdl.IsDelete = IsDelete;
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsSonuc", mdl);
            }
            if (tbInx == 6)
            {
                ...
                #endregion
                mdl.IsDelete = IsDelete;
                page = ViewRenderHelper.RenderPartialView("YYDBasvuruSureci", "getBsAnket", mdl);
            }
