    ...
    public class BasvuruSureciController : Controller
    {
        ...
        public ActionResult getBsSubData(int id, int tbInx, bool IsDelete)
        {
            ...
            if (tbInx == 1)
            {
                ...
                #endregion
                page = Management.RenderPartialView("BasvuruSureci", "getBsDetAnaBilgi", mdl);
            }
            if (tbInx == 2)
            {
                #region SinavTipleri
                ...
                #endregion
                page = Management.RenderPartialView("BasvuruSureci", "getBsSinavTipleri", mdl);
            }
            if (tbInx == 3)
            {
                ...
                #endregion
                page = Management.RenderPartialView("BasvuruSureci", "getBsKotalar", mdl);
            }
            if (tbInx == 4)
            {
                ...
                page = Management.RenderPartialView("BasvuruSureci", "getBsMulakat", mdl);
            }
            if (tbInx == 5)
            {
                ...
                #endregion
                mdl.IsDelete = IsDelete;
                page = Management.RenderPartialView("BasvuruSureci", "getBsSonuc", mdl);
            }
            if (tbInx == 6)
            {
                ...
                #endregion
                mdl.IsDelete = IsDelete;
                page = Management.RenderPartialView("BasvuruSureci", "getBsAnket", mdl);
            }
        ...
        public ActionResult Sil(int id)
        {
            ...
            if (kayit != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Management.SistemBilgisiKaydet(message, "BasvuruSureci/Sil<br/><br/>" + ex.ToExceptionStackTrace(), BilgiTipi.OnemsizHata);
        ...
        public ActionResult KazananKayit(int MulakatSonucID, int? KayitDurumID, bool YokODKontrolYap = true, bool? IsSave = null)
        {
            ...
            var ogrenciKayitBilgi = Management.StudentControl(null,ProgramBilgi.TcKimlikNo);
